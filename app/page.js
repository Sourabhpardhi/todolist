...
const page = () => {
  ...
  renderTask = mainTask.map((t,i)=>{
    return(
      ...
      <button onClick={()=>{deleteHandeler(i)}} className='bg-red-400 text-white px-4 py-2 rounded font-bold'>Delete</button>
      </li>
    );  
  })
}
  return (
    <>
    <h1 className='bg-black text-white p-5 text-5xl font-bold text-center'>Lucky's Todo List</h1>
